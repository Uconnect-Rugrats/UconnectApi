...
public class ReaccionController {
	...
	@GetMapping
	public ResponseEntity<Response<ReaccionDTO>> list(@RequestBody ReaccionDTO dto) {
	...
	@PostMapping
	public ResponseEntity<Response<ReaccionDTO>> create(@RequestBody ReaccionDTO dto) {
		facade = new ReaccionFacadeImpl();
		...
		try {
			...
			response.getMessages().add(
					"Se ha presentado un problema inesperado. Por favor contacte con el administrador del sistema");
	...
	@PutMapping("/{id}")
	public ResponseEntity<Response<ReaccionDTO>> update(@PathVariable UUID id, @RequestBody ReaccionDTO dto) {
		facade = new ReaccionFacadeImpl();
